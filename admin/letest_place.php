...
$query="INSERT INTO `letest_place`(`id`, `name`, `country`, `img`, `dis`, `status`) VALUES (null, '$name', '$country','$img','$dis','$st')";
...
?>
        ...
        <td><img src="<?php echo "upload/".$row['img']; ?>" width="50%"></td>
        ...
        <td><a href="update_letest.php?id=<?php echo $row['id'];?>" class="btn btn-info">Update</a></td>
       

       <td>
       
        <a href="delete_letest.php?id=<?php echo $row['id'];?>" class="btn btn-danger">Delete</a>
