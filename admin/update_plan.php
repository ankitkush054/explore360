...
//  {
        ...
        $query = "UPDATE `places` SET `place_name`='$nam',`place_discription`='$disc',`status`='$st',`price`='$pric',`place_img`='$img' ,`place_country`='$cont' WHERE `place_id`='$user_id'"; 
...
<h2 style="margin-left:433px; margin-top:12px;"><b> Places form</b></h2>
  ...
  <input class="form-control" name="img"  accept="image/*" type="file" id="formFile">
    ...
    <input type="text" placeholder="Enter place name" class="form-control" name="name" value="<?php echo $nam;?>" required> </td>
    </div>
    </tr>
    ...
    <tr>
    <div class="mb-3">
    <label for="formFile" class="form-label">country Name</label>
    <input type="text" placeholder="Enter place name" class="form-control" name="country" value="<?php echo $cont;?>" required> </td>
    </div>
    </tr>

    <tr>
    <div class="mb-3">
    <label for="formFile" class="form-label">place description</label>
    <input type="text" class="form-control" placeholder="Enter place discription" name="dis" value="<?php echo $disc;?>" required></td>
    </div>
    </tr>
    ...
    <input type="text" class="form-control" placeholder="Enter price" name="price" value="<?php echo $pric;?>" required></td>
    </div>
    </tr>
    ...
    <input type="boolen" class="form-control" placeholder="status" name="status" value="<?php echo $st;?>" required></td>
    </div>
    </tr>   
